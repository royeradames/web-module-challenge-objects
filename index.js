...
// console.log(createMenuItem("Chicken burger", 2, "Lunch"));
// console.log(createMenuItem("Salad", 3, "Breakfast"));
// console.log(createMenuItem("Smoothie", 5, "Lunch"));
...
// */
  ...
  //   const allLongReviews = [];
  //   let totalWords, 
  //       noLongReviews = [];
  //   for(let i = 0; i < reviews.length; i++)
  //   {
  //     totalWords = reviews[i].feedback.split(" ").length;
  //     if ( totalWords >= 15){
  //       allLongReviews.push(reviews[i].feedback);
  //     }
  //   }  
  //   if(allLongReviews === noLongReviews)
  //   {
  //     allLongReviews.push("Reviews are not longer than 15 words");
  //   }
  //     return allLongReviews;
  // }
